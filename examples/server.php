...
$flow = new SequenceFlow([
    new Flow($addOneJob, new MaxIpStrategy(1), $driver),
    new Flow($multbyTwoJob, new MaxIpStrategy(3), $driver),
    new Flow($minusThreeJob, new MaxIpStrategy(2), $driver),
]);

$flow = new ErrorFlow($flow, $errorJob, new MaxIpStrategy(2), $driver);
